---
title: JettyApplicationEngine.stop - 
layout: api
---

<div class='api-docs-breadcrumbs'><a href="../index.html">io.ktor.server.jetty</a> / <a href="index.html">JettyApplicationEngine</a> / <a href="./stop.html">stop</a></div>
...
Overrides <a href="../-jetty-application-engine-base/stop.html">JettyApplicationEngineBase.stop</a>
...
<code>timeUnit</code> - the <a href="http://docs.oracle.com/javase/6/docs/api/java/util/concurrent/TimeUnit.html">TimeUnit</a> for <a href="stop.html#io.ktor.server.jetty.JettyApplicationEngine$stop(kotlin.Long, kotlin.Long, java.util.concurrent.TimeUnit)/timeout">timeout</a>
---
title: ActorSelectorManager - 
layout: api
---

<div class='api-docs-breadcrumbs'><a href="../index.html">io.ktor.network.selector</a> / <a href="./index.html">ActorSelectorManager</a></div>
...
<a href="../-selector-manager-support/cancelled.html">cancelled</a>
...
<a href="../-selector-manager-support/pending.html">pending</a>
...
<a href="../-selector-manager-support/provider.html">provider</a>
...
<a href="../-selector-manager-support/apply-interest.html">applyInterest</a>
...
<a href="../-selector-manager-support/cancel-all-suspensions.html">cancelAllSuspensions</a>
...
<a href="../-selector-manager-support/handle-selected-key.html">handleSelectedKey</a>
...
<a href="../-selector-manager-support/handle-selected-keys.html">handleSelectedKeys</a>
...
Handle selected keys clearing <a href="../-selector-manager-support/handle-selected-keys.html#io.ktor.network.selector.SelectorManagerSupport$handleSelectedKeys(kotlin.collections.MutableSet((java.nio.channels.SelectionKey)), kotlin.collections.Set((java.nio.channels.SelectionKey)))/selectedKeys">selectedKeys</a> set
...
<a href="../-selector-manager-support/notify-closed-impl.html">notifyClosedImpl</a>
...
<a href="../-selector-manager-support/select.html">select</a>
...
Suspends until <a href="../-selector-manager-support/select.html#io.ktor.network.selector.SelectorManagerSupport$select(io.ktor.network.selector.Selectable, io.ktor.network.selector.SelectInterest)/interest">interest</a> is selected for <a href="../-selector-manager-support/select.html#io.ktor.network.selector.SelectorManagerSupport$select(io.ktor.network.selector.Selectable, io.ktor.network.selector.SelectInterest)/selectable">selectable</a>

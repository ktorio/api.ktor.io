---
title: HttpClientCall - 
layout: api
---

<div class='api-docs-breadcrumbs'><a href="../index.html">io.ktor.client.call</a> / <a href="./index.html">HttpClientCall</a></div>
...
A class that represents a single pair of <a href="request.html">request</a> and <a href="response.html">response</a> for a specific <a href="../../io.ktor.client/-http-client/index.html">HttpClient</a>.
...
Represents the <a href="response.html">response</a> sent by the server.
...
<a href="response-config.html">responseConfig</a>
...
Closes the underlying <a href="response.html">response</a>.
...
<td markdown="1">
<div class="signature"><code><span class="keyword">suspend</span> <span class="keyword">fun </span><span class="symbol">&lt;</span><span class="identifier">T</span><span class="symbol">&gt;</span> <a href="./index.md"><span class="identifier">HttpClientCall</span></a><span class="symbol">.</span><span class="identifier">receive</span><span class="symbol">(</span><span class="symbol">)</span><span class="symbol">: </span><a href="../receive.html#T"><span class="identifier">T</span></a></code></div>

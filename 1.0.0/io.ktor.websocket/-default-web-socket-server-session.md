---
title: DefaultWebSocketServerSession - 
layout: api
---

<div class='api-docs-breadcrumbs'><a href="index.html">io.ktor.websocket</a> / <a href="./-default-web-socket-server-session.html">DefaultWebSocketServerSession</a></div>
...
<a href="../io.ktor.http.cio.websocket/-default-web-socket-session/index.html">DefaultWebSocketSession</a>
...
<a href="-web-socket-server-session/call.html">call</a>
...
Associated received <a href="-web-socket-server-session/call.html">call</a> that originating this session
...
<a href="../io.ktor.http.cio.websocket/-default-web-socket-session/close-reason.html">closeReason</a>


</td>
<td markdown="1">
<div class="signature"><code><span class="keyword">abstract</span> <span class="keyword">val </span><span class="identifier">closeReason</span><span class="symbol">: </span><span class="identifier">Deferred</span><span class="symbol">&lt;</span><a href="../io.ktor.http.cio.websocket/-close-reason/index.html"><span class="identifier">CloseReason</span></a><span class="symbol">?</span><span class="symbol">&gt;</span></code></div>
...
<a href="../io.ktor.http.cio.websocket/-default-web-socket-session/ping-interval.html">pingInterval</a>
...
<a href="../io.ktor.http.cio.websocket/-default-web-socket-session/timeout.html">timeout</a>
...
It doesn't have any effect if <a href="../io.ktor.http.cio.websocket/-default-web-socket-session/ping-interval.html">pingInterval</a> is <code>null</code> (pinger is disabled).
